...
**************************************************************************************
	...
	*Define directories: 
	...
	global effectsizes			"$project_folder/raw_data/effect sizes"
...
keep if year == 2006
keep if birthmo <. 
hist birthmo if age <= 15, disc freq xlabel(1/13) legend(off) title("(c) Census 2006: Month of birth") xtitle("Month of birth") ytitle("Frequency") ylabel(0 "0" 2000 "2000" 4000 "4000" 6000 "6000" 8000 "8000" 10000 "10000") xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec" 13 " ",labsize(vsmall)) 
...
addplot: , yscale(r(0 1)) ylabel(0(.2)1)
graph save Graph "graph 2.dta", replace
...
graph save Graph "graph 3.dta", replace
rdplot grade8ormore birthmo if schage==15, c(6.5) nbins(5 5) p(2) graph_options(xtitle("Month of birth relative to cutoff") ytitle("Pr (attend Grade 8 or more)") xlabel(2(1)11) legend(off) title((d) Grade 8 or higher (monthly bins)))))
addplot: , xlabel(2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov")
addplot: , yscale(r(0 1)) ylabel(0(.2)1)
graph save Graph "graph 4.dta", replace
...
use "$dhs_data/dhspooled.dta", clear // DHS pooled sample of women and men
keep if age >= 18 & age <= 59
rdplot agri birthmo, nbins(1000 1000) c(6.5) p(2) ci(95) graph_options(xtitle("Month of birth") ytitle("Pr (worked in agriculture)") xlabel(1/12) legend(off) title((b) Employed in agriculture)))
...
use "$dhs_data/dhspooled.dta", clear // DHS pooled sample of women and men
keep if age >= 18 & age <= 59
rdplot highskill birthmo, nbins(1000 1000) c(6.5) p(2) ci(95) graph_options(xtitle("Month of birth") ytitle("Pr (high-class occupation)") xlabel(1/12) legend(off) title((c) High-class occupation)))
...
addplot: , text(.445 9.5 "RD: 0.014 (s.e.: 0.015)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 1.dta", replace
...
addplot: , text(.61 9.5 "RD: 0.016 (s.e.: 0.021)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 2.dta", replace
...
addplot: , text(.2 9.5 "RD: 0.014 (s.e.: 0.013)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 3.dta", replace
...
addplot: , text(.41 9.5 "RD: -0.002 (s.e.: 0.023)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 4.dta", replace
...
addplot: , text(.12 9.5 "RD: 0.020 (s.e.: 0.011)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 5.dta", replace
...
addplot: , text(.061 9.5 "RD: 0.015 (s.e.: 0.014)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 6.dta", replace
...
addplot: , text(2.99 9.5 "RD: 0.162 (s.e.: 0.044)", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
...
use "$dhs_data/dhspooled.dta", clear // DHS pooled sample of women and men
keep if age >= 20 & age <= 49
rdplot spousedu birthmo, nbins(1000 1000) c(6.5) p(2) ci(95) graph_options(xtitle("Month of birth") ytitle("Spousal education (years)") xlabel(1/12) legend(off) title((d) Spousal education)))
addplot: , text(5.1 9.5 "RD: 0.388 (s.e.: 0.152) ", size(small)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec")
graph save Graph "graph 4.dta", replace
...
addplot: , text(2.05 9.5 "RD: -0.209 (s.e.: 0.049) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 1.dta", replace
...
addplot: , text(1.05 9.5 "RD: -0.089 (s.e.: 0.082) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 2.dta", replace

use "$dhs_data/dhspooled.dta", clear 
keep if age >= 20 & age < = 59
rdplot agefirstkid20 birthmo if fem == 1, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(vsmall)) ytitle("Pr(age at first child < 20)", size(vsmall)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((c) Age at first child <20 (female)))) 
...
use "$dhs_data/dhspooled.dta", clear 
keep if age >= 20 & age < = 59
rdplot agefirstkid20 birthmo if fem == 0, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(vsmall)) ytitle("Pr(age at first child < 20)", size(vsmall)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((d) Age at first child <20 (male)))) 
...
addplot: , text(.755 9.5 "RD: -0.032 (s.e.: 0.012) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 5.dta", replace
...
addplot: , text(.555 9.5 "RD: -0.029 (s.e.: 0.019) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 6.dta", replace

use "$dhs_data/dhspooled.dta", clear 
keep if age >= 20 & age < = 59
rdplot agefirstmarr20 birthmo if fem == 1, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(vsmall)) ytitle("Pr(age at first marriage < 20)", size(vsmall)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((g) Age at  marriage <20 (female)))) 
addplot: , text(.46 9.5 "RD: -0.044 (s.e.: 0.016) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 7.dta", replace

use "$dhs_data/dhspooled.dta", clear 
keep if age >= 20 & age < = 59
rdplot agefirstmarr20 birthmo if fem == 0, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(vsmall)) ytitle("Pr(age at first marriage < 20)", size(vsmall)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((h) Age at marriage <20 (male)))) 
addplot: , text(.045 9.5 "RD: -0.013 (s.e.: 0.014) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(vsmall))
graph save Graph "graph 8.dta", replace

graph combine "graph 1.dta" "graph 2.dta" "graph 3.dta" "graph 4.dta" "graph 5.dta" "graph 6.dta" "graph 7.dta" "graph 8.dta", col(2) ysize(4) xsize(3) scale(1)
gr export "$figures/health_outcomes_gender.jpg", replace 

* Resuls for HIV by gender

use "$dhs_data/dhshiv.dta", clear
keep if age >= 18 & age < = 49
rdplot hivpos birthmo if fem == 1, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(small)) ytitle("Pr(HIV positive)", size(small)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((a) HIV infection (female)))) 
addplot: , text(.255 9.5 "RD: 0.021 (s.e.: 0.021) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(small))
graph save Graph "graph 1.dta", replace

use "$dhs_data/dhshiv.dta", clear
keep if age >= 18 & age < = 49
rdplot hivpos birthmo if fem == 0, c(6.5) nbins(1000 1000) p(2) ci(95) graph_options(xtitle("Month of birth", size(small)) ytitle("Pr(HIV positive)", size(small)) xlabel(1(1)12, labsize(small) valuelabel) legend(off) title((b) HIV infection (male)))) 
addplot: , text(.15 9.5 "RD: -0.041 (s.e.: 0.020) ", size(vsmall)) xlabel(1 "Jan" 2 "Feb" 3 "Mar" 4 "Apr" 5 "May" 6 "Jun" 7 "Jul" 8 "Aug" 9 "Sep" 10 "Oct" 11 "Nov" 12 "Dec", labsize(small))
graph save Graph "graph 2.dta", replace

graph combine "graph 1.dta" "graph 2.dta", col(2)
gr export "$figures/HIV_gender.jpg", replace 
...
* Data on effect sizes for years of schooling from selected existing studies 

clear
import excel "$effectsizes/Effect size data.xlsx", sheet("Sheet1") firstrow clear

set scheme plotplain

gen loggdp = log(GDPpercapitain2023current)

graph twoway ///
    (sc Effectsizeyears loggdp if Sample=="Women", mlabel(Country)) ///
    (sc Effectsizeyears loggdp if Sample=="Men", mlabel(Country)) ///
	(lfit Effectsizeyears loggdp), ///
	ytitle("{bf}Effect size (years of schooling)") ///
	xtitle("{bf} Log GDP per capita") ///
	yline(0, lcolor(red)) ///
	ylab(-.4(0.2).8) xlab(6.5(1)12.5) ///
    legend(pos(2) ring(0) col(1) order(1 2) lab(1 "Women") lab(2 "Men"))	

gr export "$figures/effect sizes.png", replace
