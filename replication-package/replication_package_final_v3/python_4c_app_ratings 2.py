...
while y > 2011:
	...
	while m>0:
		...
		if m<10:
			...
			csvfilename = "appratings_"+stry+"_0"+strm+"_26.csv"
		else: 
			filename = stry+strm+"26"
			csvfilename = "appratings_"+stry+"_"+strm+"_26.csv"
		...
		for line in open(filename, 'r'):
			...
			subdict = dict((k, row[k]) for k in ('id', 'all_histogram'))
			list_id_genre = [subdict.get('id'), subdict.get('all_histogram')]
