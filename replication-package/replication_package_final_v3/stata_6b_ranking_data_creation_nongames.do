clear
set more off
cd "$P_Ranking_Data_NonGames"

cap erase "$P_Data_Processed/android_toprankings_nongames_weekly.dta"
...
foreach file of local files {
	...
	* v8 new free
	...
	while `i'<=5 {
		...
		cap append using "$P_Data_Processed/android_toprankings_nongames_weekly.dta"
		save "$P_Data_Processed/android_toprankings_nongames_weekly.dta", replace 
...
clear 
use "$P_Data_Processed/android_toprankings_nongames_weekly.dta"
